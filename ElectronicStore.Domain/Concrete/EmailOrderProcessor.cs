...
namespace ElectronicStore.Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string MailFromAddress = "electronicstore@example.com";
        ...
        public string FileLocation = @"c:\Users\User\Documents\Visual Studio 2013\Projects\ElectronicStore\electronic_store_emails";
    }
    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                MailMessage mailMessage = new MailMessage(_emailSettings.MailFromAddress, // From       
